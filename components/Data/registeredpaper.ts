...
const defaultPapers: Paper[] = [
  ...
  },
  {
    ...
    "Paper-ID": 341,
    "Name of Author": "PRANSHU JENA",
    "Title of Paper": "RegUNeXt with Hybrid Attention for Advanced Segmentation for tumorous Region in Brain Tumor.",
    "Author Institution": "NIT Rourkela"
  },
  {
    "SL. No": 56,
    "Paper-ID": 155,
    "Name of Author": "Pramod Maurya",
    "Title of Paper": "Neural Radiance Fields, Gaussian Splatting and its applications in Underwater Archaeology",
    "Author Institution": "CSIR NIO"
  },
  {
    "SL. No": 57,
    "Paper-ID": 342,
    "Name of Author": "Nikhil Pandey",
    "Title of Paper": "A Physics-Informed Hybrid Solver for Sparse Seismic Inversion: Wedgelet–TGV with ADMM–ALM–AFISTA",
    "Author Institution": "IIT KGP"
  },
  {
    "SL. No": 58,
    "Paper-ID": 127,
    "Name of Author": "Johnson Brian Kayongo",
    "Title of Paper": "Low-Cost IoT and TinyML for Offline Early Chronic Disease Risk Identification in African Communities",
    "Author Institution": "The African Leadership University"
  },
  {
    "SL. No": 59,
    "Paper-ID": 409,
    "Name of Author": "Prasenjit Betal",
    "Title of Paper": "A Multi-Descriptor Framework for Image-Based Genotype Classification in Plants",
    "Author Institution": "IIT KGP"
  },
  {
    "SL. No": 60,
